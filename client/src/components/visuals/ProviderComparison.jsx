...
const PROVIDERS = [
  ...
  },
  {
    ...
    type: 'Closed',
    cost: '$$',
    strength: 'Constitutional AI safety, 1M context window, top coding & agentic benchmarks (Feb 2026)',
    color: '#6B46C1',
    logo: 'A',
  },
  {
    ...
    type: 'Closed',
    cost: '$-$$$',
    strength: 'Natively multimodal, huge context, deep Google Workspace & Search integration',
    color: '#38BDF8',
    logo: 'G',
  },
  {
    ...
    type: 'Open',
    cost: 'Free',
    strength: 'MoE open weights (Scout/Maverick/Behemoth), multimodal, 10M context on Scout',
    color: '#F59E0B',
    logo: 'M',
  },
  {
