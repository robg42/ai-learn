...
const PROVIDERS = [
  {
    ...
    type: 'Closed',
    cost: '$$',
    strength: 'Broadest ecosystem, strong general reasoning, extensive tool integrations',
    color: '#10B981',
    logo: 'O',
  },
  {
    ...
    type: 'Closed',
    cost: '$$',
    strength: 'Safety-focused, long context window, nuanced instruction following',
    color: '#6B46C1',
    logo: 'A',
  },
  {
    ...
    type: 'Closed',
    cost: '$-$$$',
    strength: 'Multimodal by design, deep Google product integration',
    color: '#38BDF8',
    logo: 'G',
  },
  {
    ...
    type: 'Open',
    cost: 'Free',
    strength: 'Open weights, fully self-hostable, strong community fine-tuning',
    color: '#F59E0B',
    logo: 'M',
  },
  {
    ...
    type: 'Open/Closed',
    cost: '$',
    strength: 'Efficient inference, European provider, strong multilingual support',
    color: '#EC4899',
    logo: 'Mi',
  },
];
